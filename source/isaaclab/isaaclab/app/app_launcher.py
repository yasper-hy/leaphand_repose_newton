...
class AppLauncher:
    ...
    def _check_if_omniverse_required(self) -> bool:
        ...
        # Keep backward compatibility with older alias "kit".
        if self._visualizer is not None and ("omniverse" in self._visualizer or "kit" in self._visualizer):
            return True
    ...
    def _resolve_headless_settings(self, launcher_args: dict, livestream_arg: int, livestream_env: int):
        ...
        omniverse_visualizer_requested = visualizers_requested and (
            "omniverse" in visualizers or "kit" in visualizers
        )
